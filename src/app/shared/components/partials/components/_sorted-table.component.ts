...
import { ColumnWidthsDirective } from 'src/app/shared/directives/column-widths.directive';
import { PositionStickyDirective } from 'src/app/shared/directives/position-sticky.directive';
...
export abstract class SortedTableComponent<TData> {
	...
	@ViewChild('stickyHeader', { read: ColumnWidthsDirective }) 
		stickyHeader?: ColumnWidthsDirective;
	@ViewChild('hiddenHeader', { read: ColumnWidthsDirective }) 
		hiddenHeader?: ColumnWidthsDirective;
